...
import { FileText, Calendar, ChevronLeft, ChevronRight, Search, Tag as TagIcon, X } from "lucide-react"
...
export default function DocumentList() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (searchMode === "filename") {
        console.log("Searching by filename:", filenameQuery.trim())
  ...
  // 초기 로딩 시에만 early return (검색 모드가 아닐 때)
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-gray-900">
          {searchMode === "paginated" ? "업로드된 문서" : "검색 결과"}
        </h2>
